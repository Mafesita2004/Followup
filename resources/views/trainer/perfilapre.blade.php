    ...
    <body class="font-['Arial',sans-serif] bg-white m-0 flex flex-col min-h-screen">
        ...
        <main class=" bg-gray-100 m-2 px-2 rounded-3xl max-height-100% w-5/7 border-2 border-black w-11/12 min-h-screen ml-16">
            <div class="mx-auto mt-2 mb-2 bg-white rounded-lg shadow-lg border-black border-2 h-100%">
                <div class="flex items-center justify-center space-x-4 mb-6">
                    <h3 class="text-xl text-center 8-2 font-bold">Aprendiz</h3>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="border-4 justify-center m-4">
                        <div class="bg-gray-200 rounded-full mx-48 mt-2">
                            <img src="{{ asset('img/user-icon.png') }}" alt="Avatar" class="h-22 w-22 border-2 border-black rounded-full">
                    </div>
                    <div>
                        <div class="w-full">
