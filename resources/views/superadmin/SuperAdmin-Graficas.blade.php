      ...
      {{-- FIN Barra Azul --}}
          ...
          <div class="w-full flex justify-center">
              <ul class="horizontal-list flex space-x-4 justify-center items-center" >
                  ...
                  <li>
                      <a href="{{ route('superadmin.SuperAdmin-Graficas') }}" class="block text-center text-white px-4 py-2 rounded-lg {{ request()->routeIs('superadmin.SuperAdmin-Graficas') ? 'bg-green-600 bg-opacity-70' : 'bg-green-600 bg-opacity-20 hover:bg-opacity-50' }}">
