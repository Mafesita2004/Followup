...
<body class="font-['Arial',sans-serif] bg-white m-0 flex flex-col min-h-screen">
    ...
    <div class="flex flex-col border-2 border-[#D9D9D9] bg-[#ffffff] w-[900px] h-[500px] p-5 mx-auto my-5 rounded-lg shadow-md">
        <form id="emailForm">
            <label class="flex flex-col">
                ...
                <textarea id="description" name="documentos" rows="4" class="w-full h-[300px] p-2 border border-gray-300 bg-[#D9D9D9] rounded-lg resize-none"></textarea>
            </label>
    ...
    <script src="{{ asset('js/SuperAdmin/email.js') }}"></script>
</body>
</html>
