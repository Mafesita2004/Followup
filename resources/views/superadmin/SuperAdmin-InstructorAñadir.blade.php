...
<body class="font-['Arial',sans-serif] bg-white m-0 flex flex-col min-h-screen">
    ...
    <nav class="bg-[#00324d] px-2.5 py-1.5 flex justify-start items-center relative z-10">
        ...
        <div class="text-white text-center absolute left-1/2 transform -translate-x-1/2">Agregar Instructor</div>
            ...
            <div class=" bg-gray-100 p-6 rounded-lg">
                <div class="text-center mb-6">
                    ...
                    <div class="flex justify-end mt-6 space-x-4">
                        <a type="submit" href="{{ route('superadmin.SuperAdmin-Instructor')}}" class="bg-green-700 hover:bg-green-900 text-white py-2 px-4 rounded">Confirmar</a>
