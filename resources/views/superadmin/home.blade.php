...
>>>>>>> 6e9aaf128792fe0fffda4ac4d45d76e5880ee92a
        </button>
    ...
    <main class="flex flex-col items-center mt-4 relative">
        <div class="w-full flex justify-between items-center mb-4 flex-wrap">
            ...
            <form action="#" method="GET" class="mr-8">
                <a href="{{route('superadmin.SuperAdmin-AdministratorAñadir')}}" class="bg-white border-none p-2 cursor-pointer">
