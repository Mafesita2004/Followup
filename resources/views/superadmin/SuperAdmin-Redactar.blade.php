  ...
  <header class="bg-white text-[#009e00] px-5 py-2.5 flex flex-col items-center border-t-[5px] border-t-white border-b border-b-[#e0e0e0]">
    ...
    <nav class="bg-[#009e00] px-2.5 h-14 py-1.5 flex justify-end items-center relative z-10">
        <div class="w-full flex justify-center">
            <ul class="horizontal-list flex space-x-4 justify-center items-center">
                ...
                <li><a href="{{ route('superadmin.SuperAdmin-Administrator') }}" class="block text-white text-center bg-transparent px-4 py-2 rounded-lg hover:bg-green-700 transition">Administrador</a></li>
                <li><a href="{{ route('superadmin.SuperAdmin-Instructor') }}" class="block text-center text-white px-4 py-2 rounded-lg {{ request()->routeIs('superadmin.SuperAdmin-Instructor') ? 'bg-green-600 bg-opacity-70' : 'bg-green-600 bg-opacity-20 hover:bg-opacity-50' }}">Instructor</a></li>
    ...
    <div class="flex justify-center">
        <main class="bg-white m-4 p-2 rounded-lg shadow-[0_0_10px_rgba(0,0,0,0.8)] border-[#2F3E4C] w-2/3 items-center">
            ...
            <form class="mb-4">
                <input type="text" placeholder="Para" class="border p-2 rounded w-full mb-2" required>
                <input type="text" placeholder="Título" class="border p-2 rounded w-full mb-2" required>
                <textarea placeholder="Asunto" class="border p-2 rounded w-full mb-2" required></textarea>
    ...
    <script>
        // Aquí iría el código de validación JS
    </script>
