      ...
      <div class="w-full flex justify-between items-center mt-6">
        ...
        <div class="flex flex-col border-2 border-[#D9D9D9] bg-[#ffffff] w-[900px] h-[500px] p-5 mx-auto my-5 rounded-lg shadow-md">
            ...
            <div class="flex justify-end gap-2 mt-5">
                <button type="button" class="bg-gray-300 hover:bg-gray-400 text-black py-2 px-4 rounded" onclick="window.location.href='{{ route('administrator.notificaciones') }}'">CANCELAR</button>
