...
<body class="font-['Arial',sans-serif] bg-white m-0 flex flex-col min-h-screen">
    ...
    {{-- FIN Barra Azul --}}
        ...
        <div class="text-white text-center absolute left-1/2 transform -translate-x-1/2">Base de Datos</div>
    ...
    <div class="w-full flex items-center mt-6">
        ...
        <h2 class="text-xl font-serif">Agregar Aprendices</h2>
    </div>
        {{-- FIN Menu --}}
    ...
    <div class="w-full max-w-6xl bg-[#2f3e4c14] border-2 border-[#04324D] rounded-lg p-6 shadow-[0_0_10px_rgba(0,0,0,0.8)] mt-1">
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-6 gap-4">
            ...
            @endphp
            @for ($i = 0; $i < 24; $i++)
                <a href='{{ route('administrator.Añadir-aprendiz') }}' class="w-40px h-30px  bg-white border-2 border-[#009E00] rounded-2xl m-4 p-2 flex flex-col items-center hover:bg-green-100">
