                    ...
                    <form action='/api/user_registers' method="POST">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-6">
                            <div class="w-full">
                                ...
                                <input type="text" name="id" class="w-full border border-gray-300 rounded-lg p-2.5" placeholder="Identificación" required>
                            </div>
                            <div class="w-full">
                            ...
                            <div class="w-full">
                                ...
                                <input type="text" name="email" class="w-full border border-gray-300 rounded-lg p-2.5" placeholder="Celular" required>
                            </div>
                            <div class="w-full">
                                <label class="block text-gray-700">Tipo de Contrato</label>
                                <input type="text" name="Contract_Type" class="w-full border border-gray-300 rounded-lg p-2.5" placeholder="Total de horas" required>
                            </div>
                            <div class="w-full">
                            ...
                            <div class="w-full">
                                ...
                                <input type="text" name="Nit_empresa" class="w-full border border-gray-300 rounded-lg p-2.5" required>
                            </div>
                            <div class="w-full">
                                <label class="block text-gray-700">Razón Social</label>
                                <input type="text" name="Company_Name" class="w-full border border-gray-300 rounded-lg p-2.5" required>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-6">
                            ...
                            <div class="w-full">
                                ...
                                <input type="text" name="telephone" class="w-full border border-gray-300 rounded-lg p-2.5" placeholder="Barrio" required>
                            </div>
                            <div class="w-full">
                                <label class="block text-gray-700">Nombre instructor</label>
                                <input type="text" name="name_instructor" class="w-full border border-gray-300 rounded-lg p-2.5" placeholder="Barrio" required>
                            </div>
                            <div class="w-full">
                                <label class="block text-gray-700">Correo instructor</label>
                                <input type="text" name="email_instructor" class="w-full border border-gray-300 rounded-lg p-2.5" placeholder="Barrio" required>
                            </div>
                        </div>

                        <div class="flex space-x-4 justify-start mb-4">
                            <button type="button" class="bg-[#009e00] text-white px-3 py-1 rounded">Enviar Aprendiz</button>
                            <button type="button" class="bg-[#009e00] text-white px-3 py-1 rounded">Enviar Instructor</button>
                        ...
                        <button type="submit" class="w-full bg-[#009e00] text-white py-3 rounded-lg mt-6">Registrar</button>
                    </form>
                </div>
            </main>
        </div>
