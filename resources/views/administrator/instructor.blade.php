              ...
              <ul class="horizontal-list flex space-x-4 justify-center" >
                  ...
                  <li>
                    <a href="{{ route('administrator.instructor') }}"
                       class="block text-center text-white px-4 py-2 rounded-lg {{ request()->routeIs('administrator.instructor') ? 'bg-green-600 bg-opacity-70' : 'bg-green-600 bg-opacity-20 hover:bg-opacity-50' }}">
